...
In your model:
  ...
  # you should use the :logical_delete if you do logical delete and the method to verify if a record is deleted is different than :deleted?, disregard if not using logical deletes
